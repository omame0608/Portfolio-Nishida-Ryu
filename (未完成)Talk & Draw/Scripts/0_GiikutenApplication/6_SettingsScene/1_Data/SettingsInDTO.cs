namespace GiikutenApplication.SettingsScene.Data
{
    ...
    public class SettingsInDTO
    {
        ...
        private readonly string _jobName; //ジョブ名
        private readonly string _bloodType; //血液型
        private readonly int _height; //身長
        private readonly string _birthday; //誕生日
        private readonly string _favoriteWeather; //好きな天気
        private readonly string _favoriteColor; //好きな色
        private readonly string _dominantHand; //利き手
        private readonly string _text; //自己紹介
